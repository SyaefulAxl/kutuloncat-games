...
3. Isi form:
   ...
   - **No. HP:** Nomor WhatsApp aktif (format: 08xxx atau 628xxx)
   - **Email:** Alamat email (opsional)
   - **Kode Referral:** Jika kamu punya kode dari teman (opsional)
4. Klik **"Kirim OTP"**
5. Cek WhatsApp kamu, masukkan kode OTP 6 digit
...
1. Buka **kutuloncat.fun**
2. Masukkan **No. HP** yang sudah terdaftar
3. Klik **"Masuk"**
4. Cek WhatsApp untuk kode OTP (demi keamanan)
5. Masukkan OTP dan klik **"Verifikasi"**
6. Kamu akan diarahkan ke Dashboard
...
**Q: Kenapa harus verifikasi WhatsApp?**
A: Untuk keamanan akun dan mencegah pembuatan akun palsu.

**Q: Bisakah saya main di HP?**
A: Ya! Semua game sudah dioptimasi untuk mobile browser.

**Q: Bagaimana cara dapat achievement?**
A: Mainkan game dan capai target tertentu. Achievement otomatis terbuka.

**Q: Kode referral saya tidak diterima?**
A: Pastikan kode 4 digit dan masih valid. Hubungi admin jika bermasalah.

**Q: Apakah skor bisa direset?**
A: Admin bisa mengatur season untuk reset leaderboard.
