...
const RAYUAN_LINES = [
  ...
  'AKU SUKA SAMA KAMU', 'MAU JADI PACARKU?',
  'KAMU TUH KAYAK BENSIN', 'BIKIN HATI IRIT MELAJU',
  'KAMU KAYAK TV', 'SINYALNYA SAMPE HATI',
  'APA KAMU KOPI?', 'SOALNYA BIKIN GAK TIDUR',
  'KAMU MATAHARI?', 'KALO GAK ADA KAMU GELAP',
  'INI DOMPET HILANG', 'SOALNYA HATI UDAH JATUH',
  'POSESIF BOLEH?', 'AKU CEMAS KAMU DIREBUT',
  'AKU LELAH', 'BERJUTA JAUH DARI KAMU',
  'KAMU KUNCI?', 'BIKIN HATI TERKUNCI',
  'KAMU BAHAYA', 'SOALNYA BIKIN KECANDUAN',
  'KAMU ES KRIM?', 'HATI DINGIN TERUS LEMBUT',
  'KAMU INTERNET?', 'GABISA JAUH DARI KAMU',
  'KAMU TUH PAHIT', 'TAPI OBAT BUAT AKU',
];
const RAYUAN_WIN_LINES = [
  'MAU NIKAH SAMA AKU?',
  'KAMU TUH CINTA SEJATI',
  'BAWA KE ORANG TUA YUK!',
  'CINTA SEJATI DI SINI',
  'KAU BIDADARI TERSEMBUNYI',
  'HANYA KAMU YANG AKU CARI',
  'AKU NYEBRANG CUMA BUAT KAMU',
];
